...
function App() {
  ...
  const allBooks = useMemo(() => {
    const _books = Object.values(books[debouncedSearchQuery] || {}).flat();
    const lastElement: ("error" | "loader")[] = [];
    if (error[debouncedSearchQuery]) {
      lastElement.push("error");
    } else if (hasMore[debouncedSearchQuery]) {
                  ...
                  if (book === "error") {
                    return (
                      ...
                      >
                        ...
                        {error[debouncedSearchQuery] ?? "Unknown error"}
                      </div>
                    );
                  }
                }
